...
---}
---```
---@class _.lspconfig.settings.ruff.Ruff.CodeAction.DisableRuleComment
...
---}
---```
---@class _.lspconfig.settings.ruff.Ruff.CodeAction.FixViolation
---Enable the Quick Fix.
---
---```lua
---default = true
...
---@class _.lspconfig.settings.ruff.Ruff.CodeAction
---Whether to display Quick Fix actions to disable rules via `noqa` suppression comments.
---
---```lua
---default = {
...
---}
---```
---@field disableRuleComment? _.lspconfig.settings.ruff.Ruff.CodeAction.DisableRuleComment
---Whether to display Quick Fix actions to autofix violations.
---
---```lua
---default = {
...
---}
---```
---@field fixViolation? _.lspconfig.settings.ruff.Ruff.CodeAction.FixViolation

---@class _.lspconfig.settings.ruff.Ruff.Format
...
---@class _.lspconfig.settings.ruff.Ruff.Lint
...
---@class _.lspconfig.settings.ruff.Ruff.Trace
...
---@class _.lspconfig.settings.ruff.Ruff
---Additional command-line arguments to pass to `ruff check`, e.g., `"args": ["--config=/path/to/pyproject.toml"]`. Supports a subset of Ruff's command-line arguments, ignoring those that are required to operate the LSP, like `--force-exclude` and `--verbose`.
---
---**This setting is not supported by the native server.**
---
...
---```
---@field args? string[]
---@field codeAction? _.lspconfig.settings.ruff.Ruff.CodeAction
...
---@field format? _.lspconfig.settings.ruff.Ruff.Format
...
---@field lint? _.lspconfig.settings.ruff.Ruff.Lint
...
---@field trace? _.lspconfig.settings.ruff.Ruff.Trace

---@class lspconfig.settings.ruff
---@field ruff? _.lspconfig.settings.ruff.Ruff
