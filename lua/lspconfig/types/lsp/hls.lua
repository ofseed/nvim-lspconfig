...
---@class _.lspconfig.settings.hls.Haskell.Plugin.AlternateNumberFormat
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Cabal
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.CabalFmt.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.CabalFmt
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.CabalFmt.Config

---@class _.lspconfig.settings.hls.Haskell.Plugin.CabalGild.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.CabalGild
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.CabalGild.Config

---@class _.lspconfig.settings.hls.Haskell.Plugin.CabalHaskellIntegration
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.CallHierarchy
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.ChangeTypeSignature
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Class
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Eval.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Eval
...
---```
---@field codeLensOn? boolean
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.Eval.Config

---@class _.lspconfig.settings.hls.Haskell.Plugin.ExplicitFields
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.ExplicitFixity
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Fourmolu.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Fourmolu
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.Fourmolu.Config

---@class _.lspconfig.settings.hls.Haskell.Plugin.Gadt
---Enables gadt plugin
---
---```lua
---default = true
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideCodeActionsBindings
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideCodeActionsFillHoles
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideCodeActionsImportsExports
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideCodeActionsTypeSignatures
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideCompletions.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideCompletions
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.GhcideCompletions.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideHoverAndSymbols
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideTypeLenses.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.GhcideTypeLenses
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.GhcideTypeLenses.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Hlint.Config
---Flags used by hlint
---
---```lua
---default = {}
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Hlint
...
---```
---@field codeActionsOn? boolean
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.Hlint.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.ImportLens
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.ModuleName
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Ormolu.Config
---Call out to an external "ormolu" executable, rather than using the bundled library
---@field external? boolean

---@class _.lspconfig.settings.hls.Haskell.Plugin.Ormolu
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.Ormolu.Config

---@class _.lspconfig.settings.hls.Haskell.Plugin.OverloadedRecordDot
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.PragmasCompletion
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.PragmasDisable
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.PragmasSuggest
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.QualifyImportedNames
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Rename.Config
---Enable experimental cross-module renaming
---@field crossModule? boolean

---@class _.lspconfig.settings.hls.Haskell.Plugin.Rename
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.Rename.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Retrie
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.SemanticTokens.Config
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.SemanticTokens
---@field config? _.lspconfig.settings.hls.Haskell.Plugin.SemanticTokens.Config
---Enables semanticTokens plugin
---@field globalOn? boolean

---@class _.lspconfig.settings.hls.Haskell.Plugin.SignatureHelp
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Splice
...
---@class _.lspconfig.settings.hls.Haskell.Plugin.Stan
---Enables stan plugin
---@field globalOn? boolean

---@class _.lspconfig.settings.hls.Haskell.Plugin
---@field alternateNumberFormat? _.lspconfig.settings.hls.Haskell.Plugin.AlternateNumberFormat
---@field cabal? _.lspconfig.settings.hls.Haskell.Plugin.Cabal
---@field ["cabal-fmt"]? _.lspconfig.settings.hls.Haskell.Plugin.CabalFmt
---@field ["cabal-gild"]? _.lspconfig.settings.hls.Haskell.Plugin.CabalGild
---@field cabalHaskellIntegration? _.lspconfig.settings.hls.Haskell.Plugin.CabalHaskellIntegration
---@field callHierarchy? _.lspconfig.settings.hls.Haskell.Plugin.CallHierarchy
---@field changeTypeSignature? _.lspconfig.settings.hls.Haskell.Plugin.ChangeTypeSignature
---@field class? _.lspconfig.settings.hls.Haskell.Plugin.Class
---@field eval? _.lspconfig.settings.hls.Haskell.Plugin.Eval
---@field ["explicit-fields"]? _.lspconfig.settings.hls.Haskell.Plugin.ExplicitFields
---@field ["explicit-fixity"]? _.lspconfig.settings.hls.Haskell.Plugin.ExplicitFixity
---@field fourmolu? _.lspconfig.settings.hls.Haskell.Plugin.Fourmolu
---@field gadt? _.lspconfig.settings.hls.Haskell.Plugin.Gadt
---@field ["ghcide-code-actions-bindings"]? _.lspconfig.settings.hls.Haskell.Plugin.GhcideCodeActionsBindings
---@field ["ghcide-code-actions-fill-holes"]? _.lspconfig.settings.hls.Haskell.Plugin.GhcideCodeActionsFillHoles
---@field ["ghcide-code-actions-imports-exports"]? _.lspconfig.settings.hls.Haskell.Plugin.GhcideCodeActionsImportsExports
---@field ["ghcide-code-actions-type-signatures"]? _.lspconfig.settings.hls.Haskell.Plugin.GhcideCodeActionsTypeSignatures
---@field ["ghcide-completions"]? _.lspconfig.settings.hls.Haskell.Plugin.GhcideCompletions
---@field ["ghcide-hover-and-symbols"]? _.lspconfig.settings.hls.Haskell.Plugin.GhcideHoverAndSymbols
---@field ["ghcide-type-lenses"]? _.lspconfig.settings.hls.Haskell.Plugin.GhcideTypeLenses
---@field hlint? _.lspconfig.settings.hls.Haskell.Plugin.Hlint
---@field importLens? _.lspconfig.settings.hls.Haskell.Plugin.ImportLens
---@field moduleName? _.lspconfig.settings.hls.Haskell.Plugin.ModuleName
---@field ormolu? _.lspconfig.settings.hls.Haskell.Plugin.Ormolu
---@field ["overloaded-record-dot"]? _.lspconfig.settings.hls.Haskell.Plugin.OverloadedRecordDot
---@field ["pragmas-completion"]? _.lspconfig.settings.hls.Haskell.Plugin.PragmasCompletion
---@field ["pragmas-disable"]? _.lspconfig.settings.hls.Haskell.Plugin.PragmasDisable
---@field ["pragmas-suggest"]? _.lspconfig.settings.hls.Haskell.Plugin.PragmasSuggest
---@field qualifyImportedNames? _.lspconfig.settings.hls.Haskell.Plugin.QualifyImportedNames
---@field rename? _.lspconfig.settings.hls.Haskell.Plugin.Rename
---@field retrie? _.lspconfig.settings.hls.Haskell.Plugin.Retrie
---@field semanticTokens? _.lspconfig.settings.hls.Haskell.Plugin.SemanticTokens
---@field signatureHelp? _.lspconfig.settings.hls.Haskell.Plugin.SignatureHelp
---@field splice? _.lspconfig.settings.hls.Haskell.Plugin.Splice
---@field stan? _.lspconfig.settings.hls.Haskell.Plugin.Stan

---@class _.lspconfig.settings.hls.Haskell.Trace
...
---@class _.lspconfig.settings.hls.Haskell
...
---@field plugin? _.lspconfig.settings.hls.Haskell.Plugin
...
---@field trace? _.lspconfig.settings.hls.Haskell.Trace
...
---@class lspconfig.settings.hls
---@field haskell? _.lspconfig.settings.hls.Haskell
