...
---@class _.lspconfig.settings.docker_language_server.Docker.Extension.Editor
...
---@class _.lspconfig.settings.docker_language_server.Docker.Extension
...
---@field editor? _.lspconfig.settings.docker_language_server.Docker.Extension.Editor
...
---@class _.lspconfig.settings.docker_language_server.Docker.Lsp.Experimental.Scout
...
---@class _.lspconfig.settings.docker_language_server.Docker.Lsp.Experimental
---@field scout? _.lspconfig.settings.docker_language_server.Docker.Lsp.Experimental.Scout
...
---@class _.lspconfig.settings.docker_language_server.Docker.Lsp
---Enter the port on localhost where the language server is running, used for debugging.
---@field debugServerPort? number
---@field experimental? _.lspconfig.settings.docker_language_server.Docker.Lsp.Experimental
...
---@class _.lspconfig.settings.docker_language_server.Docker
---@field extension? _.lspconfig.settings.docker_language_server.Docker.Extension
---@field lsp? _.lspconfig.settings.docker_language_server.Docker.Lsp

---@class lspconfig.settings.docker_language_server
---@field docker? _.lspconfig.settings.docker_language_server.Docker
